...
<div style="margin:0 auto;background-color:white;">
	<div style="margin:0 auto;background-color:white;">
		...
		<sf:form modelAttribute="tipoOperacao" action="novaOperacao">
			...
			<input <c:out value="${status_botoes.get('inicio_almoco')}"/> type="submit" name="descricao" value="Inicio Almoço"/>
		</sf:form>
		...
		<sf:form modelAttribute="tipoOperacao" action="novaOperacao">
			...
			<input <c:out value="${status_botoes.get('fim_almoco')}"/> type="submit" name="descricao" value="Fim Almoço"/>
		</sf:form>
